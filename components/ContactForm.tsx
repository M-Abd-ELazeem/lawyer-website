export default function ContactForm() {
  return (
    <section className=" bg-gray-900 text-white py-16 px-16" id="contact">
      <div className="max-w-6xl mx-auto flex gap-12 items-start">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 mb-2">📞 +971 56 648 1670</p>
          <p className="text-gray-300">info@mahmoud-hassan.ae</p>
        </div>
